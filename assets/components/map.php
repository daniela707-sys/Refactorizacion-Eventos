...
<!-- Modal mapa -->
<div id="mapmodal" class="modal_map">
    <div class="modal-content_map">
        <!-- Close Button -->
        <span class="close_map">&times;</span>
        <!-- Include login content -->
        <div class="personalized-container">
            <h1 id="departamento_seleccionado">
                Elige un Departamento
            </h1>

            <!-- Indicador de filtro activo -->
            <div id="filter-indicator" class="filter-indicator" style="display: none;">
                <strong>Filtro activo:</strong> <span id="current-filter">Todos</span>
            </div>

            <!-- Contenedor de botones -->
            <div class="buttons-container">
                <button class="btn-map btn-map-primary" id="btnIniciar">📍 Mi Ubicación</button>
                <button class="btn-map btn-map-success" id="btnTodos">🌍 Ver Todos</button>
            </div>
                ...
                <div class="container_mapa">
                    <div class="map-container" id="map-container">
                        <svg xmlns:mapsvg="http://mapsvg.com" xmlns:dc="http://purl.org/dc/elements/1.1/"
                            ...
                            xmlns="http://www.w3.org/2000/svg" mapsvg:geoViewBox="-81.721283 12.590653 -66.868938 -4.237159"
                            viewBox="0 0 612.82184 693.68036" preserveAspectRatio="xMidYMid meet">
                            <path
                                ...
                                title="Amazonas" name="Amazonas" id="CO-AMA" class="region" />
                            <path
                                ...
                                title="Antioquia" name="Antioquia" id="CO-ANT" class="region" />
                            <path
                                ...
                                title="Arauca" name="Arauca" id="CO-ARA" class="region" />
                            <path
                                ...
                                title="Atlántico" name="Atlántico" id="CO-ATL" class="region" />
                            <path
                                ...
                                title="Bolívar" name="Bolívar" id="CO-BOL" class="region" />
                            <path
                                ...
                                title="Boyacá" name="Boyacá" id="CO-BOY" class="region" />
                            <path
                                ...
                                title="Cauca" name="Cauca" id="CO-CAU" class="region" />
                            <path
                                ...
                                title="Cesar" name="Cesar" id="CO-CES" class="region" />
                            <path
                                ...
                                title="Chocó" name="Chocó" id="CO-CHO" class="region" />
                            <path
                                ...
                                title="Caldas" name="Caldas" id="CO-CAL" class="region" />
                            <path
                                ...
                                title="Córdoba" name="Córdoba" id="CO-COR" class="region" />
                            <path
                                ...
                                title="Caquetá" name="Caquetá" id="CO-CAQ" class="region" />
                            <path
                                ...
                                title="Casanare" name="Casanare" id="CO-CAS" class="region" />
                            <path
                                ...
                                title="Cundinamarca" id="CO-CUN" class="region" />
                            <path
                                ...
                                title="Cundinamarca" name="Cundinamarca" id="CO-DC" class="region" />
                            <path
                                ...
                                title="Guainía" name="Guainía" id="CO-GUA" class="region" />
                            <path
                                ...
                                title="Guaviare" name="Guaviare" id="CO-GUV" class="region" />
                            <path
                                ...
                                title="Huila" name="Huila" id="CO-HUI" class="region" />
                            <path
                                ...
                                title="La Guajira" name="La Guajira" id="CO-LAG" class="region" />
                            <path
                                ...
                                title="Magdalena" name="Magdalena" id="CO-MAG" class="region" />
                            <path
                                ...
                                title="Meta" name="Meta" id="CO-MET" class="region" />
                            <path
                                ...
                                title="Nariño" name="Nariño" id="CO-NAR" class="region" />
                            <path
                                ...
                                title="Norte de Santander" name="Norte de Santander" id="CO-NSA" class="region" />
                            <path
                                ...
                                title="Putumayo" name="Putumayo" id="CO-PUT" class="region" />
                            <path
                                ...
                                title="Quindío" name="Quindío" id="CO-QUI" class="region" />
                            <path
                                ...
                                title="Risaralda" name="Risaralda" id="CO-RIS" class="region" />
                            <path
                                ...
                                title="Santander" name="Santander" id="CO-SAN" class="region" />
                            <path
                                ...
                                title="Sucre" name="Sucre" id="CO-SUC" class="region" />
                            <path
                                d="M195.9,55.1l-1.9-9.8l5.5-4.7l0.6,2L195.9,55.1z"
                                title="San Andrés y Providencia" name="San Andrés y Providencia" id="CO-SAP" class="region" />
                            <path
                                ...
                                title="Tolima" name="Tolima" id="CO-TOL" class="region" />
                            <path
                                ...
                                title="Valle del Cauca" name="Valle del Cauca" id="CO-VAC" class="region" />
                            <path
                                ...
                                title="Vichada" name="Vichada" id="CO-VID" class="region" />
                            <path
                                ...
                                title="Vaupés" name="Vaupés" id="CO-VAU" class="region" />
                        </svg>
                    </div>
...
<script>
    ...
    var closemap = document.getElementsByClassName("close_map")[0];
    var openLoginModalButton = document.getElementById("openmapmodal");

    // Inicialización del modal (mantiene compatibilidad con código original)
    if (openLoginModalButton && mapModal && closemap) {
        // Close the modal
    ...
    // Función para abrir modal desde móvil (mantiene compatibilidad)
    function openmap_mobil() {
        mapModal.style.display = "block";
        document.body.classList.add("no-scroll");
    }

    // Función para actualizar el indicador de filtro
    function updateFilterIndicator() {
        const filterIndicator = document.getElementById('filter-indicator');
        const currentFilter = document.getElementById('current-filter');
        const savedDepartamento = localStorage.getItem('departamento');

        if (savedDepartamento && savedDepartamento !== 'TODOS') {
            filterIndicator.style.display = 'block';
            currentFilter.textContent = savedDepartamento;
        } else {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const departamentoSeleccionado = document.getElementById('departamento_seleccionado');
        const btnTodos = document.getElementById('btnTodos');

        // Actualizar indicador al cargar
        updateFilterIndicator();

        // Verificar si hay un departamento guardado en localStorage
        const savedDepartamento = localStorage.getItem('departamento');
        if (savedDepartamento && savedDepartamento !== 'TODOS') {
            // Buscar el path correspondiente al departamento guardado
            paths.forEach(function(path) {
                const regionTitle = path.getAttribute('title');
                if (regionTitle === savedDepartamento) {
                    // Agregar la clase destacada a la región guardada
                    path.classList.add('selected-region');
                    // Actualizar el contenido del h1 con el departamento guardado
                    departamentoSeleccionado.innerText = savedDepartamento;
                }
            });
        } else {
            departamentoSeleccionado.innerText = 'Elige un Departamento';
        }

        // Agregar evento click a cada path
        paths.forEach(function(path) {
            path.addEventListener('click', function() {
                // Remover la clase destacada de cualquier otra región
                paths.forEach(function(p) {
                    p.classList.remove('selected-region');
                });

                // Agregar la clase destacada a la región seleccionada
                this.classList.add('selected-region');

                // Obtener el título de la región
                const regionTitle = this.getAttribute('title');
                console.log(`Clicked on region with title: ${regionTitle}`);

                // Mostrar SweetAlert con el nombre de la región
                if (regionTitle) {
                    // Guardar selección y actualizar inmediatamente
                    localStorage.setItem('departamento', regionTitle);
                    departamentoSeleccionado.innerText = regionTitle;
                    updateFilterIndicator();

                    // Mostrar mensaje sin confirmación
                    Swal.fire({
                        title: '¡Región Seleccionada!',
                        html: `
                        <div style="text-align: center;">
                            <p>Has seleccionado: <strong>${regionTitle}</strong></p>
                            <p style="color: #666; font-size: 14px; margin-top: 15px;">
                                🔍 A partir de ahora, toda la información mostrada será filtrada específicamente para esta región.
                            </p>
                            <p style="color: #666; font-size: 14px;">
                                💡 Puedes cambiar el filtro en cualquier momento usando el botón "Ver Todos" o seleccionando otra región.
                            </p>
                        </div>
                    `,
                        icon: 'success',
                    ...
                    // Cerrar modal y recargar después de 5 segundos
                    setTimeout(() => {
                        mapModal.style.display = "none";
                        document.body.classList.remove("no-scroll");
        ...
        // Evento para el botón "Ver Todos"
        if (btnTodos) {
            btnTodos.addEventListener('click', function() {
                // Aplicar cambio inmediatamente
                localStorage.setItem('departamento', 'TODOS');
                ...
                // Actualizar texto
                departamentoSeleccionado.innerText = 'Todos los Departamentos';
                updateFilterIndicator();

                // Mostrar mensaje sin confirmación
                Swal.fire({
                    title: '¡Viendo Todos los Departamentos!',
                    text: 'Ahora se muestra información de todos los departamentos sin filtro',
                    icon: 'info',
                    timer: 5000,
                    timerProgressBar: true,
                    showConfirmButton: false,
    ...
    const funcionInit = () => {
        ...
        if (!"geolocation" in navigator) {
            ...
            if (btnIniciar) {
                ...
                btnIniciar.innerHTML = '❌ No disponible';
            }
            return;
        }
        ...
        const onUbicacionConcedida = async (ubicacion) => {
            try {
                ...
                Swal.fire({
                    ...
                    text: 'Por favor espera mientras detectamos tu ubicación',
                    allowOutsideClick: false,
                    showConfirmButton: false,
                    willOpen: () => {
                        Swal.showLoading();
                ...
                const ubicacionGeografica = await obtenerUbicacionDesdeCoordenadas(
                    coordenadas.latitude,
                    coordenadas.longitude
                );

                if (ubicacionGeografica && ubicacionGeografica.state) {
                    // Aplicar filtro automáticamente sin preguntar
                    localStorage.setItem('departamento', ubicacionGeografica.state);
                    departamentoSeleccionado.innerText = ubicacionGeografica.state;

                    // Destacar región en el mapa
                    paths.forEach(function(path) {
                        const regionTitle = path.getAttribute('title');
                        if (regionTitle === ubicacionGeografica.state) {
                            path.classList.add('selected-region');
                        } else {
                            path.classList.remove('selected-region');
                        }
                    ...
                    // Mostrar mensaje directo sin confirmación
                    Swal.fire({
                        title: '¡Ubicación Detectada y Aplicada!',
                        html: `
                        <div style="text-align: center;">
                            <p><strong>País:</strong> ${ubicacionGeografica.country}</p>
                            <p><strong>Departamento:</strong> ${ubicacionGeografica.state}</p>
                            <hr style="margin: 20px 0;">
                            <p style="color: #666; font-size: 14px;">
                                El filtro para <strong>${ubicacionGeografica.state}</strong> ha sido aplicado automáticamente.
                            </p>
                        </div>
                    `,
                        icon: 'success',
                    ...
                    if ("Notification" in window && Notification.permission === 'granted') {
                        new Notification("Filtro de ubicación aplicado", {
                            body: `Ahora viendo contenido de ${ubicacionGeografica.state}`
                        });
                    }
                ...
                Swal.fire({
                    title: 'Error',
                    text: 'No se pudo obtener tu ubicación. Por favor intenta de nuevo o selecciona manualmente tu departamento.',
                    icon: 'error',
        ...
        const onErrorUbicacion = (error) => {
            let mensaje = 'No se pudo obtener tu ubicación.';

            switch (error.code) {
                case error.PERMISSION_DENIED:
                    mensaje = 'Permiso de ubicación denegado. Por favor, habilita la geolocalización en tu navegador.';
                    break;
        ...
        const obtenerUbicacion = () => {
            navigator.geolocation.getCurrentPosition(onUbicacionConcedida, onErrorUbicacion, {
        ...
        const $btnIniciar = document.querySelector("#btnIniciar");
        if ($btnIniciar) {
            $btnIniciar.addEventListener("click", obtenerUbicacion);
        }

        // Auto-ejecutar solo si no hay departamento guardado
        const savedDepartamento = localStorage.getItem('departamento');
        if (!savedDepartamento) {
            // Ejecutar automáticamente la geolocalización
            setTimeout(() => {
                obtenerUbicacion();
            }, 1000);
        }
